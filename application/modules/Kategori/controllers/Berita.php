...
class Berita extends CI_Controller {
	...
	public function getJSON(){
		...
		foreach($output as $key => $val):
			...
			$row[] = '<a href="'.base_url('kategori/berita/edit').'?session_id='.encode($val->id_kategori).'" class="btn btn-success btn-sm">Edit</a><a href="'.base_url('kategori/berita/destroy').'?session_id='.encode($val->id_kategori).'" class="btn btn-danger btn-sm">Hapus</a>';
			$result[] = $row;
		endforeach;
