  ...
  <div class="col">
    <div class="card">
      <div class="card-header">
        <div class="row">
            ...
            <div class="col-6 text-right"> 
              <a class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Tambah Data" href="<?= base_url('content/berita/add') ?>"> <span class="btn-inner--text"><i class="fa fa-plus"></i></span>Tambah Data</a>
      ...
      <div class="table-responsive py-4">
        <table class="table table-flush init-DataTable" data-url="<?= base_url('content/berita/getJSON') ?>" id="userTbl">
