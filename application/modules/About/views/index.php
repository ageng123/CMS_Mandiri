      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 sticky-content">
          ...
          <div class="blog-entry background-white border-1 border-grey-1 margin-bottom-35px">
            <div class="row">
              <div class="col-lg-3"><img  src="<?= base_url('assets/img/about/') ?>visi.png" style="width: 80%;padding-left: 30px;"></div>
              <div class="col-lg-9">
                <div class="padding-25px">
                <h3>Menjadi koperasi jasa yang <b>berkualitas</b> dan <b>terbaik</b> di Indonesia.</h3></div>
              </div>
              </div>
<div class="row"> 
            <div class="col-lg-3"><img  src="<?= base_url('assets/img/about/') ?>misi.png" style="width: 80%;padding-left: 30px;"></div>
              <div class="col-lg-9"  style="border: 0px white solid;">
                ...
                <div class="col-lg-3"><img  src="<?= base_url('assets/img/about/') ?>tujuan.png" style="padding-left: 30px;"></div>
                </div> 
  ...
  <div id="instgram-feed">
    <ul class="instagram-feed">
      <li><a href="#"><img src="demo-img/instagram-1.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-2.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-3.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-4.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-5.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-6.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-7.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-8.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-9.jpg" alt=""></a></li>
      <li><a href="#"><img src="demo-img/instagram-10.jpg" alt=""></a></li>
    </ul>
    <div class="clearfix"></div>
  </div>
  <!-- // Instgram Feed -->