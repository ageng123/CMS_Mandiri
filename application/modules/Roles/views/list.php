    ...
    <div class="col">
      <div class="card">
        ...
        <div class="table-responsive py-4">
          <table class="table table-flush initDTOnly" data-url="<?= base_url('Roles/getJSON') ?>" id="userTbl">
          ...
          <div class="card-body px-lg-5 py-lg-5">
            <form action="<?= $form_url ?>" class='row' method="POST" enctype="multipart/form-data">
              <div class="form-group col-md-12">
                <label class="form-control-label" for="">Nama Role</label>
                <input type="text" name="nama_role" value="<?= isset($form_data) ? $form_data->nama_role : '' ?>" id="" class="form-control" required>
              </div>
              </div>
