...
<body class="background-white" data-server="<?= base_url() ?>">
	...
	<header class="gradient-white box-shadow">
		<div class="background-grey-2 padding-tb-10px position-relative" style="background-color: #efebe8;">
			<div class="container">
				<div class="row">
					<div class="col-xl-8 col-lg-4  d-none d-lg-block">
						<ul class="user-area list-inline margin-0px text-black">
							<li class="list-inline-item  padding-right-50px">
								...
								<div class="col-xl-4 col-lg-4  d-none d-lg-block" style="text-align: right;">
								...
								<div class="header-output">
									<div class="container header-in">
										<div class="row">
											<div class="col-xl-2 col-lg-2">
												<a id="logo" href="<?= base_url();?>Landing" class="d-inline-block margin-tb-10px"><img src="<?= base_url('assets//') ?>img/logo.png" alt="" style="width:90%;"></a>
												<a class="mobile-toggle padding-10px background-main-color" href="#" style="margin-top: 25px;"><i class="fas fa-bars"></i></a>
											</div>
									...
									<?php if(!($this->session->userdata('full_name') || $this->session->userdata('id_role') != 3)): ?>
