...
<body class="background-white">
			...
			<div class="container header-in">
				<div class="row">
						...
						<div class="float-lg-right">
							...
							<ul id="menu-main" class="float-lg-left nav-menu link-padding-tb-25px dropdown-dark">
										...
										<ul class="sub-menu-columns">
											<li>
												...
												<ul class="mega-menu-list">
													<li><a href="home-main.html">Home - Main</a></li>
													<li><a href="home-agency.html">Home - Agency</a></li>
													<li><a href="home-agency-2.html">Home - Agency 2</a></li>
													<li><a href="home-business-1.html">Home - Business 1</a></li>
													<li><a href="home-barber.html">Home - Barber</a></li>
													<li><a href="home-beauty.html">Home - Beauty</a></li>
													<li><a href="home-business-2.html">Home - Business 2</a></li>
													<li><a href="home-business-3.html">Home - Business 3</a></li>
													<li><a href="home-pizza.html">Home - Pizza</a></li>
												</ul>
											</li>
											<li>
												<a href="#">demos Two</a>
												<ul class="mega-menu-list">
													...
													<li><a href="home-coffee.html">Home - Coffee</a></li>
													<li><a href="home-fish.html">Home - Fish</a></li>
													<li><a href="home-gym.html">Home - Gym</a></li>
													<li><a href="home-hosting.html">Home - Hosting</a></li>
													<li><a href="home-zoo.html">Home - zoo</a></li>
													<li><a href="home-logistics.html">Home - Logistics</a></li>
												</ul>
											</li>
											<li>
												...
												<ul class="mega-menu-list">
													...
													<li><a href="home-musician.html">Home - Musician</a></li>
													<li><a href="home-pets.html">Home - Pets</a></li>
													<li><a href="home-security.html">Home - Security</a></li>
													<li><a href="home-seo.html">Home - Seo</a></li>
													<li><a href="home-university.html">Home - University</a></li>
													<li><a href="home-wedding.html">Home - Wedding</a></li>
													<li><a href="home-yoga.html">Home - yoga</a></li>
												</ul>
											</li>
											<li>
												<a href="#">demos four</a>
												<ul class="mega-menu-list">
													<li><a href="home-portfolio-1.html">Home - Portfolio 1</a></li>
													<li><a href="home-portfolio-2.html">Home - Portfolio 2</a></li>
													<li><a href="home-portfolio-3.html">Home - Portfolio 3</a></li>
													<li><a href="home-portfolio-4.html">Home - Portfolio 4</a></li>
													<li><a href="home-portfolio-5.html">Home - Portfolio 5</a></li>
													<li><a href="home-portfolio-6.html">Home - Portfolio 6</a></li>
													<li><a href="home-portfolio-7.html">Home - Portfolio 7</a></li>
													<li><a href="home-portfolio-8.html">Home - Portfolio 8</a></li>
												</ul>
											</li>
										</ul>
									</div>
								...
								<li class="has-dropdown"><a href="#">Blog</a>
									<ul class="sub-menu">
										<li class="has-dropdown"><a href="#">Grid Layout</a>
											<ul class="sub-menu">
												<li><a href="blog-grid-4-colm.html">Grid 4 Columns</a></li>
												<li><a href="blog-grid-left-sidebar.html">grid left sidebar</a></li>
												<li><a href="blog-grid-no-sidebar.html">grid no sidebar</a></li>
												<li><a href="blog-grid-right-sidebar.html">grid right sidebar</a></li>
											</ul>
										</li>
										<li class="has-dropdown"><a href="#">list Layout</a>
											<ul class="sub-menu">
												<li><a href="blog-list-left-sidebar.html">list left sidebar</a></li>
												<li><a href="blog-list-no-sidebar.html">list no sidebar</a></li>
												<li><a href="blog-list-right-sidebar.html">list right sidebar</a></li>
											</ul>
										</li>
										<li class="has-dropdown"><a href="#">classic Layout</a>
											<ul class="sub-menu">
												<li><a href="blog-classic-left-sidebar.html">classic left sidebar</a></li>
												<li><a href="blog-classic-no-sidebar.html">classic no sidebar</a></li>
												<li><a href="blog-classic-right-sidebar.html">classic right sidebar</a></li>
											</ul>
										</li>
										<li class="has-dropdown"><a href="#">single Layout</a>
											<ul class="sub-menu">
										...
										<li class="has-dropdown"><a href="#">Post Formats</a>
											<ul class="sub-menu">
												...
												<li><a href="blog-html5-video-post.html">video post</a></li>
							...
							<div class="d-none d-lg-block pull-left model-link margin-top-15px">
								<a id="cart-link" class="model-link margin-left-25px opacity-hover-5" href="#">
								...
								<div class="cart-model">
									...
									<div class="media">
										<a href="#">
										<img class="d-flex align-self-start mr-3 width-50px" src="http://placehold.it/400x400" alt="Generic placeholder image">
									  </a>
										<div class="media-body">
											<a href="#" class="close"><i class="fa fa-window-close"></i></a>
											<h5 class="mt-0"><a href="#">Car Rental (Kia)</a></h5>
							...
							<div class="d-none d-lg-block search-link pull-left model-link margin-top-15px">
					...
					<div class="col-xl-2 d-none d-xl-block">
						<a href="#" class="btn btn-sm border-2 border-radius-30 btn-block margin-top-20px opacity-hover-5 background-main-color text-white hvr-sh2">Contact us</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
			<ul>
				...
				<li data-index="rs-64" data-transition="3dcurtain-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?= base_url('assets/landing_template/') ?>assets/revslider/assets/100x50_a033c-1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					...
					<!-- LAYER NR. 1 -->
					<div class="tp-caption   tp-resizeme" id="slide-64-layer-4" data-x="['left','left','left','center']" data-hoffset="['657','575','259','0']" data-y="['top','top','top','top']" data-voffset="['123','123','57','57']" data-width="none" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":10,"speed":750,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 5; white-space: normal; font-size: 71px; line-height: 22px; font-weight: 400; color: #757575;font-family:Open Sans;"><i class="pe-7s-diamond"></i> </div>

					<!-- LAYER NR. 2 -->
					<div class="tp-caption   tp-resizeme" id="slide-64-layer-1" data-x="['left','left','left','center']" data-hoffset="['652','567','257','0']" data-y="['top','top','top','top']" data-voffset="['227','227','161','161']" data-width="456" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":550,"speed":750,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 6; min-width: 456px; max-width: 456px; white-space: normal; font-size: 40px; line-height: 40px; font-weight: 300; color: #0864b2;font-family:Poppins;text-transform:capitalize;">Distinguish Yourself from the Crowd </div>

					<!-- LAYER NR. 3 -->
					<div class="tp-caption   tp-resizeme" id="slide-64-layer-2" data-x="['left','left','left','center']" data-hoffset="['653','571','257','0']" data-y="['middle','middle','middle','middle']" data-voffset="['12','12','56','56']" data-width="306" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1040,"speed":770,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 7; min-width: 306px; max-width: 306px; white-space: normal; font-size: 14px; line-height: 22px; font-weight: 300; color: #494949;font-family:Poppins;">pixel perfect creative multi purpose HTML5 Template designed with great attention to details, flexibility and performance. </div>
				...
				<li data-index="rs-65" data-transition="3dcurtain-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?= base_url('assets/landing_template/') ?>assets/revslider/assets/100x50_ee46e-2.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					...
					<!-- LAYER NR. 5 -->
					<div class="tp-caption   tp-resizeme" id="slide-65-layer-4" data-x="['left','left','left','center']" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['123','123','57','57']" data-width="none" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":10,"speed":760,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 5; white-space: normal; font-size: 71px; line-height: 22px; font-weight: 400; color: #757575;font-family:Open Sans;"><i class="pe-7s-wallet"></i> </div>

					<!-- LAYER NR. 6 -->
					<div class="tp-caption   tp-resizeme" id="slide-65-layer-1" data-x="['left','left','left','center']" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['227','227','161','161']" data-width="456" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":470,"speed":770,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 6; min-width: 456px; max-width: 456px; white-space: normal; font-size: 40px; line-height: 40px; font-weight: 300; color: #0864b2;font-family:Poppins;text-transform:capitalize;">TheNile : save your time and money </div>

					<!-- LAYER NR. 7 -->
					<div class="tp-caption   tp-resizeme" id="slide-65-layer-2" data-x="['left','left','left','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['12','12','56','56']" data-width="306" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":960,"speed":790,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 7; min-width: 306px; max-width: 306px; white-space: normal; font-size: 14px; line-height: 22px; font-weight: 300; color: #494949;font-family:Poppins;">pixel perfect creative multi purpose HTML5 Template designed with great attention to details, flexibility and performance. </div>
				...
				<li data-index="rs-67" data-transition="3dcurtain-vertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?= base_url('assets/landing_template/') ?>assets/revslider/assets/100x50_dfb1b-3.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					...
					<!-- LAYER NR. 9 -->
					<div class="tp-caption   tp-resizeme" id="slide-67-layer-4" data-x="['left','left','left','center']" data-hoffset="['650','575','259','0']" data-y="['top','top','top','top']" data-voffset="['123','123','57','57']" data-width="none" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":10,"speed":750,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 5; white-space: normal; font-size: 71px; line-height: 22px; font-weight: 400; color: #757575;font-family:Open Sans;"><i class="pe-7s-global"></i> </div>

					<!-- LAYER NR. 10 -->
					<div class="tp-caption   tp-resizeme" id="slide-67-layer-1" data-x="['left','left','left','center']" data-hoffset="['652','567','257','0']" data-y="['top','top','top','top']" data-voffset="['227','227','161','161']" data-width="456" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":550,"speed":750,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 6; min-width: 456px; max-width: 456px; white-space: normal; font-size: 40px; line-height: 40px; font-weight: 300; color: #0864b2;font-family:Poppins;">Responsive Multi-Purpose Html5 Theme </div>

					<!-- LAYER NR. 11 -->
					<div class="tp-caption   tp-resizeme" id="slide-67-layer-2" data-x="['left','left','left','center']" data-hoffset="['653','571','257','0']" data-y="['middle','middle','middle','middle']" data-voffset="['12','12','56','56']" data-width="306" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1040,"speed":770,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 7; min-width: 306px; max-width: 306px; white-space: normal; font-size: 14px; line-height: 22px; font-weight: 300; color: #494949;font-family:Poppins;">pixel perfect creative multi purpose HTML5 Template designed with great attention to details, flexibility and performance. </div>

					<!-- LAYER NR. 12 -->
					<div class="tp-caption rev-btn rev-withicon " id="slide-67-layer-3" data-x="['left','left','left','center']" data-hoffset="['651','568','257','0']" data-y="['top','top','top','top']" data-voffset="['439','439','381','381']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="button" data-responsive_offset="on" data-responsive="off" data-frames='[{"delay":1590,"speed":790,"frame":"0","from":"y:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"0","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(0,0,0,1);bg:rgba(255,255,255,1);bs:solid;bw:0 0 0 0;"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[12,12,12,12]" data-paddingright="[35,35,35,35]" data-paddingbottom="[12,12,12,12]" data-paddingleft="[35,35,35,35]" style="z-index: 8; white-space: nowrap; font-size: 14px; line-height: 17px; font-weight: 300; color: rgba(255,255,255,1);font-family:Poppins;background-color:rgba(8, 100, 178, 0.75);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">Buy Now<i class="fa-icon-chevron-right"></i> </div>
				</li>
			</ul>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6 sm-mb-30px wow fadeInUp">
					<div class="text-center hvr-grow opacity-hover-7">
						...
						<p class="opacity-7">Responsive &amp; Raw Multi-Purpose Multi-Page &amp; One-Page HTML5 Template. Build whatever you like with this Template.</p>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 background-white">
				<div class="">
					<div class="margin-bottom-40px font-weight-300 wow fadeInUp">
						...
						<div class="opacity-7">Responsive and Raw Multi-Purpose Multi-Page and One-Page HTML5 Template. Build whatever you like with this Template</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-6 margin-bottom-30px wow fadeInUp" data-wow-delay="0.2s">
							<div class="text-left opacity-hover-7 hvr-bob">
								<h3 class="margin-tb-10px">
									<i class="fab fa-codepen text-icon-large d-inlin-block margin-right-20px"></i> Graphic Designs
								</h3>
								<p class="opacity-7">Responsive &amp; Raw Multi-Purpose Multi-Page &amp; One-Page HTML5 Template. Build whatever you like with this Template.</p>
							</div>
						</div>
						<div class="col-lg-6 margin-bottom-30px wow fadeInUp">
							<div class="text-left opacity-hover-7 hvr-bob">
								<h3 class="margin-tb-10px">
									<i class="fab fa-fly text-icon-large d-inlin-block margin-right-20px"></i> New Designs
								</h3>
								<p class="opacity-7">Responsive &amp; Raw Multi-Purpose Multi-Page &amp; One-Page HTML5 Template. Build whatever you like with this Template.</p>
							</div>
						</div>
						<div class="col-lg-6 margin-bottom-30px  wow fadeInUp" data-wow-delay="0.2s">
							<div class="text-left opacity-hover-7 hvr-bob">
								<h3 class="margin-tb-10px">
									<i class="far fa-lightbulb text-icon-large d-inlin-block margin-right-20px"></i> Distinctive ideas
								</h3>
								<p class="opacity-7">Responsive &amp; Raw Multi-Purpose Multi-Page &amp; One-Page HTML5 Template. Build whatever you like with this Template.</p>
							</div>
						</div>
			...
			<div class="col-lg-6 background-overlay border-radius-500 wow fadeInUp" style="background-image: url('http://placehold.it/1012x765');">
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row justify-content-center wow fadeInUp">
				<div class="col-md-8">
					<div class="text-center margin-bottom-55px text-white">
						...
						<span class="opacity-7">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</span>
					</div>
				</div>
			</div>
			<!-- // section title -->
			...
			<div class="row text-white">
				<div class="col-lg-3 col-md-6 margin-bottom-30px wow fadeInUp">
					<div class="text-left hvr-bob opacity-hover-7">
						<h2 class="text-extra-large  margin-tb-10px">
							<i class="fas fa-paint-brush text-icon-large d-inlin-block margin-right-20px"></i> Unlimited Colors
						</h2>
						<p class="opacity-7">Responsive &amp; Raw Multi-Purpose Multi-Page &amp; One-Page HTML5 Template. Build whatever you like with this Template.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 margin-bottom-30px wow fadeInUp" data-wow-delay="0.2s">
					<div class="text-left hvr-bob opacity-hover-7">
						<h2 class="text-extra-large  margin-tb-10px">
							<i class="fas fa-desktop text-icon-large d-inlin-block margin-right-20px"></i> Powerful Website
						</h2>
						<p class="opacity-7">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard</p>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 margin-bottom-30px wow fadeInUp">
					<div class="text-left hvr-bob opacity-hover-7">
						...
						<p class="opacity-7">when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 margin-bottom-30px wow fadeInUp" data-wow-delay="0.2s">
					<div class="text-left hvr-bob opacity-hover-7">
				...
				<div class="col-lg-3 col-md-6 margin-bottom-30px wow fadeInUp" data-wow-delay="0.6s">
					<div class="text-left hvr-bob opacity-hover-7">
						<h2 class="text-extra-large  margin-tb-10px">
							<i class="fas fa-trophy text-icon-large d-inlin-block margin-right-20px"></i> Web Interactive
						</h2>
						<p class="opacity-7">Responsive &amp; Raw Multi-Purpose Multi-Page &amp; One-Page HTML5 Template. Build whatever you like with this Template.</p>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 sm-mb-30px wow fadeInUp" data-wow-delay="0.4s">
					<div class="blog-item background-main-color padding-40px text-center hvr-float hvr-sh2">
						<a href="#" class="text-extra-large margin-tb-20px d-block text-white">He who makes no mistakes makes nothing</a>
						<hr><span class="margin-right-30px text-white opacity-5">By : <a href="#">Rabie Elkheir</a></span>
						<hr>
						<span class="margin-right-30px text-white  opacity-5">In : <a href="#">News</a> , <a href="#">Articles</a></span>
						<hr>
						<div class="text-grey-2 text-white  opacity-6">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour ...</div>
					</div>
				</div>

				<div class="col-lg-4 col-md-6 sm-mb-30px wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-item thum-hover background-white hvr-float hvr-sh2">
						<a href="#" class="text-extra-large d-block padding-top-20px padding-lr-30px">Believe not all that you see nor half what you hear...</a>
						<hr>
						<div class="padding-lr-30px">
							<span class="margin-right-30px">By : <a href="#">Rabie Elkheir</a></span>
							<span class="margin-right-30px">In :  <a href="#">News</a> , <a href="#">Articles</a></span>
			...
			<div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
				<div class="padding-100px sm-padding-30px">
					...
					<form action="/" class="dark-form">
						...
						<a href="#" class="btn-sm hvr-shutter-in-horizontal btn-lg btn-block border-2 border-white text-dark text-center font-weight-bold text-uppercase rounded-0 padding-15px">Send</a>
					</form>
				</div>
			</div>
		</div>
