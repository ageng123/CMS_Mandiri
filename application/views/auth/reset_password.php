...
<head>
  ...
  <title>Koperasi Jasa Komunitas Panensaham Indonesia</title>
  ...
  <!-- Icons -->
  <link rel="stylesheet" href="<?= base_url('assets/new_template/') ?>/vendor/nucleo/css/nucleo.css" type="text/css">
  <link rel="stylesheet" href="<?= base_url('assets/new_template/') ?>/vendor/@fortawesome/fontawesome-free/css/all.min.css" type="text/css">
  <!-- Argon CSS -->
...
<body class="" style="background-color: #432a19;">
  ...
  <div class="main-content">
    ...
    <div class="header py-7 py-lg-8" style="background-color: #eba502;">
            ...
            <div class="card-body px-lg-5">
              ...
              <hr>
                  ...
                  <div class="text-center">
                        <h2 style="color: #432a19;"><b><?php echo lang('reset_password_heading');?></b></h2>
                  </div>
...
<?php echo form_open(base_url().'auth/reset_password/' . $code);?>
	...
	<div class="form-group mb-3">
      <div class="input-group input-group-merge input-group-alternative">
                  <p>
				  &nbsp;&nbsp;&nbsp;<b><?php echo sprintf(lang('reset_password_new_password_label'), $min_password_length);?></b><br />
					&nbsp;&nbsp;&nbsp;<?php echo form_input($new_password);?>
				</p>
				<p>
				&nbsp;&nbsp;&nbsp;<b><?php echo lang('reset_password_new_password_confirm_label', 'new_password_confirm');?></b><br />
...
<br/>
<div class="text-center">
      <?php echo form_submit('submit', lang('reset_password_submit_btn'), "class='btn btn-secondary'" );?>
      <a href="<?= base_url('admin/login') ?>" class="btn btn-link" style="color : #eba502;"> <b>Back</b></a>
</div>
...
<?php echo form_close();?>
          ...
          <div class="row mt-3">
            ...
            <!-- <div class="col-12 text-center">
              <a href="login.html#" class="text-light"><small>Create new account</small></a>
            </div> -->
          </div>
        </div>
      </div>
